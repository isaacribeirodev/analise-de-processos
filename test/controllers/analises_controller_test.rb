...
class AnalisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update analise" do
    ...
    assert_equal "Análise atualizada com sucesso.", flash[:notice]
  end
  ...
  test "should destroy analise" do
    ...
    assert_equal "Análise excluída com sucesso.", flash[:notice]
  end
end
